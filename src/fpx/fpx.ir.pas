...
type
  TIRTypeKind = fpx.ir.types.TIRTypeKind;
  TIRValueKind = fpx.ir.types.TIRValueKind;
  TIRType = fpx.ir.types.TIRType;
  TIRValue = fpx.ir.instr.TIRValue;
  TIRConstant = fpx.ir.instr.TIRConstant;
  TIRArgument = fpx.ir.instr.TIRArgument;
  TIRLocal = fpx.ir.instr.TIRLocal;
  TIRGlobal = fpx.ir.instr.TIRGlobal;
  TIRInstruction = fpx.ir.instr.TIRInstruction;
  TIRBlock = fpx.ir.instr.TIRBlock;
  TIRFunction = fpx.ir.instr.TIRFunction;
  TIRModule = fpx.ir.instr.TIRModule;
  TIRValueArray = fpx.ir.instr.TIRValueArray;
  TIRInstructionArray = fpx.ir.instr.TIRInstructionArray;
  TIRArgumentArray = fpx.ir.instr.TIRArgumentArray;
  TIRLocalArray = fpx.ir.instr.TIRLocalArray;
  TIRBlockArray = fpx.ir.instr.TIRBlockArray;
