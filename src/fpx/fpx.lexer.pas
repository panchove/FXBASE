...
type
  ...
  TFPXLexerErrors = array of TFPXLexerError;
  ...
  private
    ...
    FTokens: TTokenArray;
    FNextIndex: Integer;
    FErrors: TFPXLexerErrors;
    FKeywordMap: TDictionary<string, TKeyword>;
    FLegacyMode: Boolean;
    FStrictMode: Boolean;
    FDBAnsiMode: Boolean;
  ...
  public
    ...
    property Errors: TFPXLexerErrors read FErrors;
...
function TFPXLexerError.ToString: string;
begin
  Result := Format('FPX-%0.4d [%s:%d:%d] %s', [Code, FileName, Line, Column, Message]);
end;

constructor TFPXLexer.Create;
begin
  inherited Create;
  FTokens := nil;
  FErrors := nil;
  FNextIndex := 0;
  FKeywordMap := TDictionary<string, TKeyword>.Create;
  InitKeywords;
end;

destructor TFPXLexer.Destroy;
begin
  FKeywordMap.Free;
  inherited Destroy;
end;

procedure TFPXLexer.InitKeywords;
begin
...
function TFPXLexer.Tokenize(const ASource, AFileName: string): Boolean;
var
  c: Char;
  tok: TToken;
begin
...
function TFPXLexer.NextToken: TToken;
begin
...
function TFPXLexer.HasMoreTokens: Boolean;
begin
  Result := FNextIndex < Length(FTokens);
end;

function TFPXLexer.EOF: Boolean;
begin
...
procedure TFPXLexer.AddToken(const AType: TTokenType; const AValue: string);
var
  token: TToken;
begin
...
procedure TFPXLexer.AddTokenFull(const AType: TTokenType; const AValue: string;
  IntVal: Int64; UIntVal: UInt64; RealVal: Double; const StrVal: string; Kw: TKeyword);
var
  token: TToken;
begin
...
procedure TFPXLexer.AddError(const AMsg: string; ACode: Integer);
var
  err: TFPXLexerError;
begin
  err.Message := AMsg;
...
function TFPXLexer.CurrentChar: Char;
begin
  if FPos <= Length(FSource) then
    Result := FSource[FPos]
  else
...
function TFPXLexer.PeekChar(AOffset: Integer): Char;
var
  p: Integer;
begin
  p := FPos + AOffset;
...
function TFPXLexer.ClassifyKeyword(const AIdent: string): TKeyword;
begin
...
function TFPXLexer.ScanIdentifier: TToken;
var
...
function TFPXLexer.ScanNumber: TToken;
var
  startPos, startLine, startCol: Integer;
  value: string;
  c: Char;
...
function TFPXLexer.ScanString: TToken;
var
  startPos, startLine, startCol: Integer;
  value: string;
  quoteChar: Char;
...
function TFPXLexer.ScanRawString: TToken;
var
  startPos, startLine, startCol: Integer;
  value: string;
  quoteChar: Char;
...
function TFPXLexer.ScanOperator: TToken;
var
...
function TFPXLexer.ScanPreprocessor: TToken;
var
  startLine, startCol: Integer;
  value: string;
  c: Char;
...
function TFPXLexer.HasErrors: Boolean;
begin
  Result := Length(FErrors) > 0;
end;
